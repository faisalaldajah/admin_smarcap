...
import 'package:admin_smarcap/Model/address.dart';
import 'package:admin_smarcap/Screen/LogIn/login_binding.dart';
import 'package:admin_smarcap/Screen/LogIn/loginpage.dart';
import 'package:admin_smarcap/Screen/mainPage/MainPage.dart';
import 'package:admin_smarcap/Screen/mainPage/MainPageBinding.dart';
...
class SplashController extends GetxController {
  ...
  void getCorrectPage() async {
    if (currentFirebaseUser != null) {
      ...
      Get.to(() => const MainPageView(), binding: MainPageBinding());
    } else {
